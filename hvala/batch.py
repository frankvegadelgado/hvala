...
def main():
    ...
    helper = argparse.ArgumentParser(prog="batch_idemo", description="Compute the Approximate Vertex Cover for all undirected graphs encoded in DIMACS format and stored in a directory.")
