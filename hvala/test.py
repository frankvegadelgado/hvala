...
def main():
    ...
    helper = argparse.ArgumentParser(prog="test_idemo", description="The Hvala Testing Application using randomly generated, large sparse matrices.")
    ...
    for i in range(num_tests):
        ...
        output = f"{i + 1}-Hvala Test: {answer}" 
        utils.println(output, logger, args.log)
